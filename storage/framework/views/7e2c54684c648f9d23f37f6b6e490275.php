<div x-data="{ 
    inventory_id: <?php if ((object) ('inventory_id') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('inventory_id'->value()); ?>')<?php echo e('inventory_id'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('inventory_id'); ?>')<?php endif; ?>,
    nama_barang: <?php if ((object) ('nama_barang') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('nama_barang'->value()); ?>')<?php echo e('nama_barang'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('nama_barang'); ?>')<?php endif; ?>,
    jumlah_barang: <?php if ((object) ('jumlah_barang') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('jumlah_barang'->value()); ?>')<?php echo e('jumlah_barang'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('jumlah_barang'); ?>')<?php endif; ?>,
    harga_beli: <?php if ((object) ('harga_beli') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('harga_beli'->value()); ?>')<?php echo e('harga_beli'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('harga_beli'); ?>')<?php endif; ?>,
    harga_jual: <?php if ((object) ('harga_jual') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('harga_jual'->value()); ?>')<?php echo e('harga_jual'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('harga_jual'); ?>')<?php endif; ?>,
                                ...
                                <div class="d-flex justify-content-center gap-2">
                                    <button 
                                        x-on:click="fillForm({
                                            ...
                                            nama: '<?php echo e(addslashes($data->nama_barang)); ?>',
                                            stok: <?php echo e($data->jumlah_barang); ?>,
                                            beli: <?php echo e($data->harga_beli); ?>,
                                            jual: <?php echo e($data->harga_jual); ?>
...
</div><?php /**PATH D:\Dokumen Sekolah 12\PKL\TSM\upj_tsm_k9\resources\views\livewire\inventory-table.blade.php ENDPATH**/ ?>