...
<?php $__env->startSection('content'); ?>
    ...
    <main class="py-4">
        <div class="container">
            ...
            <form action="<?php echo e(route('admin.register.post')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role" id="roleSelect" class="form-select" required
                                    ...
                                    <option value="customer" <?php echo e(old('role') == 'customer' ? 'selected' : ''); ?>>👤 Customer
                                        (Pelanggan)</option>
                                    <option value="admin" <?php echo e(old('role') == 'admin' ? 'selected' : ''); ?>>🛠️ Admin
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hakuuu/Desktop/project/upj_tsm_k9/resources/views/auth/register.blade.php ENDPATH**/ ?>