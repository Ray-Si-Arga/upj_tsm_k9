    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            <?php if(session('print_invoice_id')): ?>
                ...
                setTimeout(() => {
                    window.open("<?php echo e(route('advisor.preview', session('print_invoice_id'))); ?>", '_blank');
                }, 1000);
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dokumen Sekolah 12\PKL\TSM\upj_tsm_k9\resources\views\advisor\create.blade.php ENDPATH**/ ?>