...
<aside class="sidebar-container" id="sidebar">
            ...
            <?php if(auth()->check() && auth()->user()->role === 'admin'): ?>
                ...
                <li class="sidebar-menu-item">
                    <a href="<?php echo e(route('admin.register')); ?>"
                        class="sidebar-menu-link <?php echo e(request()->routeIs('admin.register') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-logout">
        <a class="logout-btn" href="<?php echo e(route('logout')); ?>"
...
</script><?php /**PATH /home/hakuuu/Desktop/project/upj_tsm_k9/resources/views/components/sidebar/sidebar.blade.php ENDPATH**/ ?>