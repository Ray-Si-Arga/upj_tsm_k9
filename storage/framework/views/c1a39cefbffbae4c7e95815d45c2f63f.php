        ...
        <div class="toolbar au d1">
            <div>
                <span class="count-tag" id="countTag">
                    <i class="fas fa-calendar-alt me-1"></i><?php echo e(count($bookings)); ?> booking
                </span>
            </div>
        </div>
            ...
            <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="date-day">
                                            <?php echo e(\Carbon\Carbon::setLocale('id')); ?>

                                            <?php echo e(\Carbon\Carbon::parse($booking->booking_date)->translatedFormat('l')); ?>
                                    ...
                                    <td class="pe-4 text-end">
                                        <a href="<?php echo e(route('booking.history.detail', $booking->id)); ?>" class="btn-detail">
                ...
                <div class="t-foot">
                    <span class="t-foot-info" id="tableInfo">
                        Menampilkan <?php echo e(count($bookings)); ?> dari <?php echo e(count($bookings)); ?> booking
                    </span>
                    <span style="font-size:.74rem; color:var(--subtle);">
                        <i class="far fa-clock me-1"></i><?php echo e(now()->format('d M Y, H:i')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dokumen Sekolah 12\PKL\TSM\upj_tsm_k9\resources\views\customers\bookings.blade.php ENDPATH**/ ?>