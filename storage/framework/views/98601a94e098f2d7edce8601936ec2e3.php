        ...
        <div class="hero-section">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-md-end mt-4 mt-md-0">
                    ...
                    <div class="fw-bold fs-4"><?php echo e(date('d M Y')); ?></div>
                </div>
            </div>
        </div>
...
<div class="stats-grid">
    <div class="stats-card bg-navy-grad">
        ...
        <div>
            ...
            <div class="stats-value"><?php echo e($histories->total()); ?></div>
        </div>
    </div>
    ...
    <div class="stats-card bg-green-grad">
        ...
        <div>
            ...
            <div class="stats-value"><?php echo e($histories->count()); ?></div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('booking.walkin')); ?>" class="btn-action-outline text-decoration-none">
                <i class="fas fa-user-plus me-2"></i> Booking Walk-In
            </a>
            <a href="<?php echo e(route('advisor.create')); ?>" class="btn-action-honda text-decoration-none">
...
[$__name, $__params] = $__split('advisor-table');
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3733758710-0', $__key);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dokumen Sekolah 12\PKL\TSM\upj_tsm_k9\resources\views\advisor\index.blade.php ENDPATH**/ ?>