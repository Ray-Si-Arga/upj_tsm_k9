...
<?php $__env->startSection('title', 'Registrasi Pengguna Baru'); ?>
                ...
                <div class="form-card">
                    ...
                    <div class="card-body p-4 p-md-5">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role" id="roleSelect" class="form-select" required
                                    ...
                                    <option value="customer" <?php echo e(old('role') == 'customer' ? 'selected' : ''); ?>>ðŸ‘¤ Customer
                                        (Pelanggan)</option>
                                    <option value="admin" <?php echo e(old('role') == 'admin' ? 'selected' : ''); ?>>ðŸ› ï¸ Admin
                        ...
                        <div class="d-flex justify-content-end gap-3 mt-5">
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-light btn-modern text-secondary border">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dokumen Sekolah 12\PKL\TSM\upj_tsm_k9\resources\views\auth\register.blade.php ENDPATH**/ ?>