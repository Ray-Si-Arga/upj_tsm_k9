...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1647614439-0', $__key);
            ...
            <div class="section-wrapper">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeBookings->isEmpty()): ?>
                    ...
                    <div class="empty-panel">
                        ...
                        <a href="<?php echo e(route('pelanggan.service')); ?>" class="btn-red" style="text-decoration:none;">
                ...
                <?php else: ?>
                    ...
                    <div class="panel">
                        <div class="panel-hdr">
                            ...
                            <span class="panel-badge"><?php echo e($activeBookings->count()); ?> aktif</span>
                        </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $activeBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="booking-item">
                                ...
                                <div class="booking-meta-row">
                                    <div>
                                        ...
                                        <div class="booking-time">
                                            Jam <?php echo e(\Carbon\Carbon::parse($booking->booking_date)->format('H:i')); ?> WIB
                                        </div>
                                    </div>
                                    <span class="queue-badge">Antrian #<?php echo e($booking->queue_number); ?></span>
                                </div>

                                
                                <div class="vehicle-row">
                                    <span class="vehicle-name"><?php echo e($booking->vehicle_type); ?></span>
                                    <span class="plate-badge"><?php echo e($booking->plate_number); ?></span>
                                </div>

                                
                                <div class="service-row mb-0">
                                    <span class="service-key">Layanan</span>
                                    <span class="service-val"><?php echo e($booking->service->name ?? 'Service Umum'); ?></span>
                                </div>
                                ...
                                <div class="stepper-wrap">
                                    ...
                                    <div
                                        class="step-item <?php echo e(in_array($status, ['pending', 'approved', 'on_progress']) ? 'done' : ''); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Downloads\upj_tsm_k9\resources\views/pelanggan/dashboard.blade.php ENDPATH**/ ?>