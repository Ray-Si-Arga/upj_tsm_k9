...
<body>
        ...
        <tr>
            <td width="34%" class="b-right">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td>: <span class="dotted-text"><?php echo e($advisor->booking->queue_number); ?></span></td>
                    </tr>
                    <tr>
                        <td>Tgl Servis</td>
                        <td>: <span class="dotted-text"><?php echo e($advisor->created_at->format('d-m-Y')); ?></span></td>
                    </tr>
                    <tr>
                        <td>No. Mesin</td>
                        <td>: <span class="dotted-text"><?php echo e($advisor->engine_number); ?></span></td>
                    </tr>
                    <tr>
                        <td>No. Rangka</td>
                        <td>: <span class="dotted-text"><?php echo e($advisor->chassis_number); ?></span></td>
                    </tr>
                    <tr>
                        <td>No. Polisi</td>
                        <td>: <span class="dotted-text"><?php echo e(strtoupper($advisor->booking->plate_number)); ?></span></td>
                    </tr>
                    <tr>
                        <td>Type</td>
                        <td>: <span class="dotted-text"><?php echo e($advisor->booking->vehicle_type); ?></span></td>
                    </tr>
                    <tr>
                        <td>Tahun</td>
                        <td>: <span class="dotted-text"><?php echo e($advisor->vehicle_year); ?></span></td>
                    </tr>
                    <tr>
                        <td>KM</td>
                        <td>: <span
                                class="dotted-text"><?php echo e(number_format((float) $advisor->odometer, 0, ',', '.')); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td>: <span class="dotted-text"><?php echo e(Str::limit($advisor->customer_email, 18)); ?></span></td>
                    </tr>
                </table>
            </td>
            <td width="33%" class="b-right">
                ...
                <table width="100%">
                    <tr>
                        <td width="50">Nama</td>
                        <td>: <span class="dotted-text"><?php echo e($advisor->carrier_name); ?></span></td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td>: <span class="dotted-text"><?php echo e(Str::limit($advisor->carrier_address, 20)); ?></span></td>
                    </tr>
                    <tr>
                        <td>Kel/Kec</td>
                        <td>: <span class="dotted-text"><?php echo e($advisor->carrier_area); ?></span></td>
                    </tr>
                    <tr>
                        <td>No. HP</td>
                        <td>: <span class="dotted-text"><?php echo e($advisor->carrier_phone); ?></span></td>
                    </tr>
                </table>
                ...
                <table width="100%">
                    <tr>
                        <td width="50">Nama</td>
                        <td>: <span class="dotted-text"><?php echo e($advisor->owner_name); ?></span></td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td>: <span class="dotted-text"><?php echo e(Str::limit($advisor->owner_address, 20)); ?></span></td>
                    </tr>
                    <tr>
                        <td>No. HP</td>
                        <td>: <span class="dotted-text"><?php echo e($advisor->owner_phone); ?></span></td>
                    </tr>
                </table>
            </td>
            <td width="33%">
                <div style="margin-bottom: 5px;">
                    Dari Dealer Sendiri:
                    <span class="box symbol"><?php echo e($advisor->is_own_dealer ? '✓' : ''); ?></span> Ya
                    <span class="box symbol"><?php echo e(!$advisor->is_own_dealer ? '✓' : ''); ?></span> Tidak
                </div>
                <div style="margin-bottom: 5px;">Hubungan: <span
                        class="dotted-text"><?php echo e($advisor->relationship); ?></span></div>
                <div class="fw-bold">Alasan ke AHASS:</div>
                <table width="100%">
                    <tr>
                        <td>a. Inisiatif Sendiri</td>
                        <td class="text-right"><span
                                class="box symbol"><?php echo e($advisor->visit_reason == 'Inisiatif Sendiri' ? '✓' : ''); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td>b. SMS Reminder</td>
                        <td class="text-right"><span
                                class="box symbol"><?php echo e($advisor->visit_reason == 'SMS Reminder' ? '✓' : ''); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td>c. Telp Reminder</td>
                        <td class="text-right"><span
                                class="box symbol"><?php echo e($advisor->visit_reason == 'Telp Reminder' ? '✓' : ''); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td>d. Lainnya</td>
                        <td class="text-right"><span
                                class="box symbol"><?php echo e($advisor->visit_reason == 'Lainnya' ? '✓' : ''); ?></span></td>
                    </tr>
                </table>
            </td>
        </tr>
                        ...
                        <td width="65%" style="padding: 0; vertical-align: top;">
                            <table width="100%" class="b-bottom b-right">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><?php echo e($p_kpb ? number_format($p_kpb) : ''); ?></td>
                                </tr>
                                <tr>
                                    <td class="b-right">2. Servis Lengkap / Ringan</td>
                                    <td class="text-right"><?php echo e($p_servis ? number_format($p_servis) : ''); ?></td>
                                </tr>
                                <tr>
                                    <td class="b-right">3. Ganti Oli MPX/SPX</td>
                                    <td class="text-right"><?php echo e($p_oli ? number_format($p_oli) : ''); ?></td>
                                </tr>
                                <tr>
                                    <td class="b-right">4. Ganti Part</td>
                                    <td class="text-right"><?php echo e($p_part ? number_format($p_part) : ''); ?></td>
                                </tr>
                                <tr>
                                    <td class="b-right">5. Turun Mesin</td>
                                    <td class="text-right"><?php echo e($p_mesin ? number_format($p_mesin) : ''); ?></td>
                                </tr>
                                <tr>
                                    <td class="b-right">6. Lainnya: <?php echo e(Str::limit($name_lain, 15)); ?></td>
                                    <td class="text-right"><?php echo e($p_lain ? number_format($p_lain) : ''); ?></td>
                                </tr>
                                ...
                                <?php for($i = 0; $i < 5; $i++): ?>
                                    <tr>
                                        <td class="b-right" style="border-bottom: 1px dotted #ccc;">
                                            <?php echo e($i + 1); ?>.
                                            <?php echo e(isset($parts[$i]) ? $parts[$i]['name'] . ' (' . $parts[$i]['qty'] . ')' : ''); ?>

                                        </td>
                                        <td class="text-right" style="border-bottom: 1px dotted #ccc;">
                                            <?php echo e(isset($parts[$i]) ? number_format($parts[$i]['subtotal']) : ''); ?>
                                ...
                                <tr class="fw-bold bg-gray b-top">
                                    ...
                                    <td class="text-right">
                                        <?php echo e(number_format($advisor->total_estimation, 0, ',', '.')); ?></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" class="b-top b-right" style="padding: 0;">
                            ...
                            <div style="padding: 5px; height: 35px; font-style: italic;">
                                "<?php echo e($advisor->customer_complaint); ?>"
                            </div>
            ...
            <td width="34%" style="padding: 0; vertical-align: top;" class="b-right b-bottom b-top">
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="text-center symbol box"><?php echo e($hasPart('Busi')); ?></td>
                    </tr>
                    <tr>
                        <td class="text-center b-right">8.000</td>
                        <td class="b-right">Oli Gear</td>
                        <td class="text-center symbol box"><?php echo e($hasPart('Oli')); ?></td>
                    </tr>
                    <tr>
                        <td class="text-center b-right">24.000</td>
                        <td class="b-right">Ban Dpn</td>
                        <td class="text-center symbol box"><?php echo e($hasPart('Ban Depan')); ?></td>
                    </tr>
                    <tr>
                        <td class="text-center b-right">24.000</td>
                        <td class="b-right">Ban Blkg</td>
                        <td class="text-center symbol box"><?php echo e($hasPart('Ban Belakang')); ?></td>
                    </tr>
                    <tr>
                        <td class="text-center b-right">24.000</td>
                        <td class="b-right">Rantai/Belt</td>
                        <td class="text-center symbol box"><?php echo e($hasPart('Rantai') ?: $hasPart('Belt')); ?></td>
                    </tr>
                    <tr>
                        <td class="text-center b-right">12.000</td>
                        <td class="b-right">Coolant</td>
                        <td class="text-center symbol box"><?php echo e($hasPart('Coolant')); ?></td>
                    </tr>
                    <tr>
                        <td class="text-center b-right">24.000</td>
                        <td class="b-right">Kampas</td>
                        <td class="text-center symbol box"><?php echo e($hasPart('Kampas')); ?></td>
                    </tr>
                    <tr>
                        <td class="text-center b-right">16.000</td>
                        <td class="b-right">Filter Udara</td>
                        <td class="text-center symbol box"><?php echo e($hasPart('Filter')); ?></td>
                    </tr>
                    <tr>
                        <td class="text-center b-right">24.000</td>
                        <td class="b-right">Aki</td>
                        <td class="text-center symbol box"><?php echo e($hasPart('Aki')); ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center symbol box"><?php echo e($findPrice(['CVT']) ? '✓' : ''); ?></td>
                    </tr>
                    <tr>
                        <td class="text-center b-right">10.000</td>
                        <td class="b-right">Kuras Tangki</td>
                        <td class="text-center symbol box"><?php echo e($findPrice(['Tangki']) ? '✓' : ''); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <div style="font-size: 9px; margin-top: 5px; margin-bottom: 5px;">
        *Apabila ada tambahan PEKERJAAN di luar daftar:
        <span class="box symbol"><?php echo e($advisor->pkb_approval == 'hubungi' ? '✓' : ''); ?></span> Telp Dulu
        <span class="box symbol"><?php echo e($advisor->pkb_approval == 'langsung' ? '✓' : ''); ?></span> Langsung Kerja.
        &nbsp;&nbsp;|&nbsp;&nbsp;
        Part Bekas:
        <span class="box symbol"><?php echo e($advisor->part_bekas_dibawa == 1 ? '✓' : ''); ?></span> Dibawa
        <span class="box symbol"><?php echo e($advisor->part_bekas_dibawa == 0 ? '✓' : ''); ?></span> Ditinggal.
    </div>
    ...
    <table class="b-all text-center">
        ...
        <tr>
                ...
                <table width="100%">
                    <tr>
                        <td width="50%" style="border-right: 1px dotted black;">(
                            <?php echo e(Str::limit($advisor->carrier_name, 10)); ?> )</td>
                        <td width="50%">( SA )</td>
                    </tr>
                </table>
            </td>
            <td class="b-right text-left" style="vertical-align: top; padding: 5px;">
                Mekanik:<br>
                <b><?php echo e($advisor->nama_mekanik); ?></b>
            </td>
...
<?php /**PATH /home/hakuuu/Desktop/project/upj_tsm_k9/resources/views/advisor/print.blade.php ENDPATH**/ ?>