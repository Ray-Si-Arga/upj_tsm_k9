            ...
            <div class="success-card animate__animated animate__fadeInUp">
                ...
                <div class="card-body px-4 pb-4 pt-0">
                    ...
                    <div class="queue-box">
                        ...
                        <div class="queue-number"><?php echo e($booking->queue_number); ?></div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value text-primary"><?php echo e($booking->service->name); ?></span>
                        </div>
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value">
                                <?php echo e(\Carbon\Carbon::parse($booking->booking_date)->locale('id')->translatedFormat('l, d M Y')); ?>
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value">
                                <?php echo e($bookingTime->format('H:i')); ?> - <?php echo e($endTime); ?> WIB
                            </span>
                        </div>
                        ...
                        <div class="detail-item">
                            ...
                            <span class="badge bg-warning text-dark px-3 rounded-pill fw-bold text-uppercase"
                                ...
                                <?php echo e($booking->status == 'pending' ? 'Menunggu Konfirmasi' : $booking->status); ?>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo e(route('pelanggan.dashboard')); ?>" class="btn btn-dashboard text-white">
                            <i class="fas fa-tachometer-alt me-2"></i>Pantau Status di Dashboard
                        </a>

                        
                        <a href="<?php echo e(route('pelanggan.service')); ?>" class="btn btn-outline-custom">
                            Booking Lagi
                        </a>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dokumen Sekolah 12\PKL\TSM\upj_tsm_k9\resources\views\booking\success.blade.php ENDPATH**/ ?>