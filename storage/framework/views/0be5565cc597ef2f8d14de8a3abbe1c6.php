...
<head>
    ...
    <style>
        * {
        ...
        .left-panel {
            flex: 1;
            background-image: url('<?php echo e(asset("images/cbr.webp")); ?>');
        ...
        <div class="right-panel">
            <div class="form-wrapper">
                ...
                <form action="<?php echo e(route('login.post')); ?>" method="POST">
                    ...
                    <p class="text-center">
                        Belum punya akun? <a href="<?php echo e(route('public.register')); ?>">Daftar Sekarang</a>
                    </p>
                </form>
            </div>
        </div>
...
</html><?php /**PATH D:\Dokumen Sekolah 12\PKL\TSM\upj_tsm_k9\resources\views\auth\login.blade.php ENDPATH**/ ?>