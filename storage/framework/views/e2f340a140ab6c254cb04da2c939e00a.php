                ...
                <div class="card card-modern bg-white">
                    <div class="card-body p-5">
                        ...
                        <div class="text-center mb-4">
                            <h3 class="fw-bold text-dark"><?php echo e(__('Tambah Barang')); ?></h3>
...
unset($__errorArgs, $__bag); ?>"
                                        name="nama_barang" value="<?php echo e(old('nama_barang')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                <label for="jumlah_barang" class="form-label-custom"><?php echo e(__('Stok Awal')); ?></label>
                                <div class="input-group">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-grid gap-2 mt-5">
                                <button type="submit" class="btn btn-primary btn-modern shadow-sm">
                                    <i class="fas fa-save me-2"></i> <?php echo e(__('Simpan Data')); ?>

                                </button>
                                <a href="<?php echo e(url()->previous()); ?>" class="btn btn-light btn-modern text-muted">
                                    <?php echo e(__('Batal')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hakuuu/Desktop/project/upj_tsm_k9/resources/views/inventory/create.blade.php ENDPATH**/ ?>