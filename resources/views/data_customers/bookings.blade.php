...
@section('content')
    ...
    <style>
        ...
        .search-wrap i {
            ...
            color: var(--subtle); font-size: .85rem;
            pointer-events: none;
        }
        ...
        .date-day {
            font-size: .72rem; color: var(--subtle); margin-top: 1px;
        }
        ...
        .svc-name i { color: var(--subtle); font-size: .75rem; }
        ...
        .empty-ico {
            ...
            background: var(--red-soft); border: 1.5px solid var(--red-border);
        ...
        .empty-sub { font-size: .84rem; color: var(--subtle); }
        ...
        .t-foot-info {
            font-size: .77rem; color: var(--subtle); font-weight: 500;
        }
                    ...
                    <table class="hist-table" id="histTable">
                        ...
                        <tbody>
                            @foreach($bookings as $index => $booking)
                                <tr>
                                    {{-- No --}}
                                    <td style="text-align:center; font-family:'Syne',sans-serif; font-size:.78rem; font-weight:700; color:#cbd5e1;">
                                        {{ $index + 1 }}
                                    </td>
