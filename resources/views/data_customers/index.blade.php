    ...
    <main class="page-wrap">
        ...
        <div class="cards-grid">
            <div class="summary-card card-total au d1">
                ...
                <div class="card-amount">{{ $totalCustomers }}</div>
            </div>
            <div class="summary-card card-progress au d2">
                ...
                <div class="card-amount">{{ $newCustomers }}</div>
            </div>
            <div class="summary-card card-upcoming au d3">
                ...
                <div class="card-amount">{{ $totalAdmins }}</div>
            </div>
            <div class="summary-card card-pending au d4">
                ...
                <div class="card-amount">{{ $newAdmins }}</div>
            </div>
        </div>
        ...
        <div class="toolbar au d2">
            @livewire('search-bar', ['placeholder' => 'Cari nama, email, atau no telepon...'])
        </div>

        {{-- =============================================
        LIVEWIRE COMPONENT (CUSTOMER TABLE)
        ============================================= --}}
