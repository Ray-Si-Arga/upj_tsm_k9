        ...
        <div class="container-xl">
            ...
            <div class="table-card au d6">
                <div class="table-card-header">
                    ...
                    <span style="font-size:.75rem;color:#94a3b8;font-weight:500;">{{ date('d M Y') }}</span>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            @if (Session::has('success'))
                new Notify({
                    status: 'success', title: 'Berhasil', text: '{{ Session::get('success') }}',
                    effect: 'slide', speed: 300, autoclose: true, autotimeout: 3000, position: 'right top'
                });
            @endif
            @if (Session::has('error'))
                new Notify({
                    status: 'error', title: 'Gagal', text: '{{ Session::get('error') }}',
